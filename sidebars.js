const docs = [
  ...
  },
  {
    type: 'category',
    label: 'Drill4Net',
    items: [ 'drill4net/drill4j-admin-installation', 'drill4net/drill4net-apps', 'drill4net/one-time-setup',
      'drill4net/quick-start-guide', 'drill4net/ci-cd-integration', 'drill4net/app-under-test-setup',
      'drill4net/tests-project-setup', 'drill4net/drill4net-scanner-parameters', 'drill4net/chrome-extention',
