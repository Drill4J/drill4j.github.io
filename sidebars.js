  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: "JavaScript Agent",
            items: [
              "pre-0.8.0/for-development/java-script-agent/js-agent-admin-be-communication"
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        label: "Diagrams",
        items: [
          "pre-0.8.0/diagrams/auto-test-agent-diagrams",
          "pre-0.8.0/diagrams/testing-diagrams"
        ]
      },
