...
---
import { AdditionalInformation, Badge, Card, Warning, Info, Image, Table } from '@components'
...
<Image src="/imgs/enabled-plugin.png" />
...
<Card href="/" iconSrc="/imgs/javascript-logo.svg">JavaScript Agent</Card>
