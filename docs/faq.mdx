...
**Which test types do you support?**<br/>
We support the following test types:<br/> <a href='docs/installation/extension' target="_black">- Manual<ExternalLinkIcon/></a><br/><a href='/docs/installation/autotest-agent' target="_black">- Auto (API, UI)<ExternalLinkIcon/></a>
...
Swagger is available on port **8090** of backend service. For example, if  Drill frontend and backend parts are installed locally, then swagger is available at <a href='http://localhost:8090' target="_black">http://localhost:8090<ExternalLinkIcon/></a><br/>
Also, you can download the Postman collection with sample requests:<br/> <a href='https://github.com/Drill4J/example-configs/blob/main/postman/drill.postman_collection.json' target="_black">- Postman Collection<ExternalLinkIcon/></a><br/><a href='https://github.com/Drill4J/example-configs/blob/main/postman/drill.postman_environment.json' target="_black">- Postman Environment<ExternalLinkIcon/></a>
