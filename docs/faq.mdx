...
<a href='docs/installation/extension' target="_black">- Manual<ExternalLinkIcon/></a><br/>
<a href='/docs/installation/autotest-agent' target="_black">- Auto (API, UI)<ExternalLinkIcon/></a>
