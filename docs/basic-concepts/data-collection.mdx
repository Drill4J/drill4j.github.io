...
:::note
This is not an installation guide. For direct instructions please refer to the [Installation](#/docs/installation/setup) section.
:::

## The abstract task

There are are two key points of integration: **tests** / test runner and **target application**.
...
<Image
  ...
  "
  src="/img/data-collection-api-tests.png"
/>

1. Autotest Agent
   - Instruments TestNG classes to extract current test context
   - Each test is assigned with unique TestID
...
<Image
  ...
  "
  src="/img/data-collection-ui-tests.png"
/>
...
<Image
  ...
  "
  src="/img/data-collection-manual-tests.png"
/>
...
There are many more configurations of applications and testing environments than we could possibly list here.

**The key takeaway** is while the general principles are very much the same, **the specific** test runners, testing frameworks and transports might require separate implementations.

For the complete list of supported technologies refer to the [Supported Technologies](/docs/basic-concepts/supported-technologies) section.
