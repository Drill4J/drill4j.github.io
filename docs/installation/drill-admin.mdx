...
## Using OpenShift
You can use the following template for Drill Admin: <a href='https://github.com/Drill4J/example-configs/blob/main/openshift/drill-admin-example-openshift.yaml' target="_black">Drill Admin Example Onpeshift<ExternalLinkIcon/></a>

## Using Kubernetes
You can use the following config files for Drill Admin:
