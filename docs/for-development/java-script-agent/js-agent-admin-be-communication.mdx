...
<Badge color="#BFC7D5">"text"</Badge> field is stringified.
...
- <Badge color="#BFC7D5">/agent/change-header-name</Badge> 
- <Badge color="#BFC7D5">/agent/set-packages-prefixes</Badge> 
- <Badge color="#BFC7D5">/agent/load-classes-data</Badge> 
...
<Badge color="#BFC7D5">"content"</Badge> field is stringified.
</AdditionalInformation>

## Agent Registration & Test2Code Plugin Initialization

1. Open WS connection to Admin backend API on the <Badge color="#BFC7D5">/agent/attach</Badge> route (e.g. <Badge color="#BFC7D5">http://localhost:8090/agent/attach</Badge>) with the following headers specified:
