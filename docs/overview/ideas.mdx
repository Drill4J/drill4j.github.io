...
- **Everyone** - get a complete and continious metrics for each application version, for any test type, for all services. Track how changes to tests and code impact your coverage.
- **Test automation** - find and cover testing gaps with ease;
- **Manual QA** - reduce manual work, know exactly what to test;
- **Developers** - see which code was touched by the failed test without additional logging.

As a bonus Drill4J provides a common ground for QA engineers and developers to go from, as any failed test now generates a comprehensive coverage report just for that particular test.
...
- for Android client application;
- for all of the above;

## Testing types

As well as combine reports for various types of tests:
