...
1. Install [Drill4Net.Receiver](https://www.nuget.org/packages/Drill4Net.Receiver.Kafka) in *application under test* start up project.
...
1. Install [Drill4Net.Receiver](https://www.nuget.org/packages/Drill4Net.RabbitMQ) in *application under test* start up project.
...
3. Add call in Startup/Program `RabbitMqPatcher.PatchReceiver();`.
