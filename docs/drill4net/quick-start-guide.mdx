...
Perform a [one time setup](./one-time-setup) before you continue with this guide.
...
3. [Run Drill4Net Scanner](./one-time-setup#7-run-drill4net-scanner) but this time change value of `adminAgentConfig:buildVersion` in appsettings.yml
