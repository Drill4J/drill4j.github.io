...
When running a bunch of tests on different machines, it's essential to maintain consistency in test sessions. To achieve this, you can set up a unique session identifier using environment variables.
Ensure that you maintain this session ID consistency across all test machines.