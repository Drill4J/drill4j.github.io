...
1. Open Metabase UI in browser ([http://localhost:8095](http://localhost:8095) by default in case of local deployment)

    You should be greeted with authentication page.
    
    <Image alt="Metabase authentication form" src="/imgs/0.10.0/metabase/sign-in.PNG" />
    ...
    If you need dashboard editing permissions, use the admin account:
