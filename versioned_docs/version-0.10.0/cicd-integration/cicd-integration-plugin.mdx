...
Prerequisites:
- Before running, make sure the application under test has already been deployed and covered with [coverage collection](#coverage-collection) enabled.
- [Baseline](#baseline-strategy) is configured.
