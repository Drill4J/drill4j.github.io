...
1. Add `DRILL_APPLICATION_AGENT_URL` to [GitHub secrets and variables](https://docs.github.com/en/actions/security-for-github-actions/security-guides/using-secrets-in-github-actions#creating-secrets-for-a-repository).
  ...
  Set its value to URL of release's .zip file from [https://github.com/Drill4J/java-agent/releases](https://github.com/Drill4J/java-agent/releases)

  For example:

  <a href={`https://github.com/Drill4J/java-agent/releases/download/v${versions.javaAgent}/agent-linuxX64-${versions.javaAgent}.zip
  `}> {`https://github.com/Drill4J/java-agent/releases/download/v${versions.javaAgent}/agent-linuxX64-${versions.javaAgent}.zip`} </a>
