...
> Note: If you're using Maven or Gradle to run tests, consider using [Drill4J CI/CD Integration Plugin](/docs/cicd-integration/cicd-integration-plugin) instead. 
> It handles agent configuration automatically without requiring manual parameter setup.
