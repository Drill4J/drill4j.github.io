...
6. __Check Drill4J UI__ to confirm it has information on the application classes.
...
If your application classes aren't showing up in Drill4J UI after Tomcat is restarted and your application is loaded:
