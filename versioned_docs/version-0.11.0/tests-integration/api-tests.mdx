...
The Drill4J CI/CD integration plugin allows you to run API tests together with the Drill4J agent.
...
To enable the Drill4J agent set the plugin configuration:
...
2. To confirm the agent is working check tests log.
There should be Drill4J ASCII logo followed by agent version:
...
That’s it! Open Drill4J UI and confirm that the new test information is coming through.
You should see the test launches on the build summary page.