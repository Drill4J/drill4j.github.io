...
<Image alt='Swagger UI' src="/img/0.9.0/metabase/admin-settings-1.PNG" />

Move to the `Databases` menu on the header and click on the `Drill4J_PostgreSQL_DB` record.
<Image alt='Swagger UI' src="/img/0.9.0/metabase/admin-settings-2.PNG" />

Check the Database connection details and fix them if needed.
<Image alt='Swagger UI' src="/img/0.9.0/metabase/admin-settings-3.PNG" />
...
<Image alt='Swagger UI' src="/img/0.9.0/metabase/admin-settings-4.PNG" />
