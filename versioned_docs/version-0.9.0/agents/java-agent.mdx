...
Drill4J Java Agent is a unified agent for JVM-based applications. It enables metrics collection, test-to-code mapping, and test context propagation.

Key features:
- Code coverage collection for applications
- Test context propagation - mapping tests to code coverage and vice versa
