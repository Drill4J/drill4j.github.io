...
2. [Set path to agent when running tests](#how-to-set-path-to-agent)
...
Refer to [next section](/docs/agents/autotest-agent#how-to-set-path-to-agent) for further steps.
