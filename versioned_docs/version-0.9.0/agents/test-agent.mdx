...
1. Download release appropriate for your platform at  [https://github.com/Drill4J/autotest-agent/releases/tag/v0.23.1](https://github.com/Drill4J/autotest-agent/releases/tag/v0.23.1).
...
| Parameter            | Required |  Description                                                                                                                                                                |
|----------------------|----------|----------------------------------------------------------------------------|
| testTracingEnabled   | no       | Enables test tracing. If enabled, collected coverage will be related to the executed test, otherwise only to the test session
| testLaunchMetadataSendingEnabled    | no     | Enables sending test launch metadata to Drill4J Backend.
