...
```groovy
enableAppAgent {
    //Any additional parameters for Application Agent
    additionalParams = mapOf(
        "param1" to "value1",
        "param2" to "value2"
    )
...
> 🚧 TODO - explain when to call in CI/CD pipeline 🚧
...
### Tests does not appear in Drill4J after running in Maven with Java 17
