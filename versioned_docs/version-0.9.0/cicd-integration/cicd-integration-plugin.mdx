...
You can find more details in the [Test agent parameters](../agents/java-agent#agent-parameters-reference) reference.
...
You can send information about your application’s build to Drill4J.
