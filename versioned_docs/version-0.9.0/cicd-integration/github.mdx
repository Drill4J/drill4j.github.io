...
1. Build your application and send the build information to Drill4J.
2. Deploy the application with the Drill4J Application Agent.
3. Execute API tests using the Drill4J Test Agent.
4. Submit a Drill4J Change Testing Report.
...
3. The [set up Drill4J CI/CD Integration plugin](../cicd-integration/cicd-integration-plugin#adding-plugin) is configured in your Gradle or Maven build file.
...
This data provides key details about the commit, author, and branch associated with your application’s build.
...
3. Once the build information has been successfully submitted, detailed insights will be available in the Metabase Build Dashboard.
