...
Perform an <Link to="/docs/drill4net/one-time-setup" target="_blank">agent one time setup</Link> before you continue with this guide.
...
<Image src="/imgs/drill4net/extension-to-drill4j-admin.png"/>
...
<Image src="/imgs/drill4net/manual-tests-test2code.png"/>
...
<details> 
    ...
    <Image src="/imgs/drill4net/browser-extension-manual-test.gif"/>
</details>
